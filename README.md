...
<div class="container" id="loading">
  <div id="intro">Calculating destiny… 💫</div>
</div>

<div class="container" id="main" style="display:none">
  <h1>Uswa, will you be my Valentine? 💘</h1>
...
<div class="container" id="celebrate">
  💍 YAYYYY USWA 💕<br><br>
  Today, tomorrow, always — it’s you.<br>
  Love, <b>Husnain</b> 💖
</div>
...
function runNo(){
  ...
  if(tries>2)shy.textContent="Destiny already knows your answer 😌";
}
